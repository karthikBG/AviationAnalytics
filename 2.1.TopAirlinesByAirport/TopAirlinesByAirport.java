...
public class TopAirlinesByAirport {


    public static class SourceCarrierMap extends Mapper<Object, Text, Text, Text> {
    ...
    public static class SourceCarrierReduce extends Reducer<Text, Text, Text, Text> {
        @Override
        public void reduce(Text key, Iterable<Text> values, Context context) throws IOException, InterruptedException {
            ...
            String out = airportList.toString();
    ...
    public static void main(String[] args) throws Exception {
        ...
        Job jobA = Job.getInstance(conf, "AirlinesByAirport");
        jobA.setOutputKeyClass(Text.class);
        jobA.setOutputValueClass(Text.class);

        jobA.setMapperClass(SourceCarrierMap.class);
        jobA.setReducerClass(SourceCarrierReduce.class);
        ...
        jobB.setMapperClass(TopSourceCarrierMap.class);
        jobB.setReducerClass(TopSourceCarrierReduce.class);

...
public class TopAirlinesByRoute {

    public static class SourceDestinationCarrierMap extends Mapper<Object, Text, Text, Text> {
        ...
        public void map(Object key, Text value, Context context) throws IOException, InterruptedException {
            ...
            if (contents.length > 0 && !contents[0].equalsIgnoreCase("year") && !contents[18].equalsIgnoreCase("1")) {
                String originDest = contents[15] + "->" + contents[16];
                String airline = contents[8];
                if (!contents[13].isEmpty()) {
                    int arrivalDelay = (int) (Float.parseFloat(contents[13]));

                    context.write(new Text(originDest), new Text(airline + "_" + arrivalDelay));
                }
            }
        }
    }

    public static class SourceDestinationCarrierReduce extends Reducer<Text, Text, Text, Text> {
        @Override
    ...
    public static class TopSourceDestinationCarrierMap extends Mapper<Text, Text, Text, Text> {
    ...
    public static class TopSourceDestinationCarrierReduce extends Reducer<Text, Text, Text, Text> {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Job jobA = Job.getInstance(conf, "AirlinesByRoute");
        jobA.setOutputKeyClass(Text.class);
        jobA.setOutputValueClass(Text.class);

        jobA.setMapperClass(SourceDestinationCarrierMap.class);
        jobA.setReducerClass(SourceDestinationCarrierReduce.class);
        ...
        jobB.setMapperClass(TopSourceDestinationCarrierMap.class);
        jobB.setReducerClass(TopSourceDestinationCarrierReduce.class);
